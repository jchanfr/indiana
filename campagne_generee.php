                ...
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-lg-5 col-md-8">
                            <h2>Bravo</h2>
                            <p class="lead">Votre campagne d'impressions connectées est bien générées.</p>
                            <button class="btn btn--primary type--uppercase"><a href="dashboard.php">Allez au Dashboard</a></button>
