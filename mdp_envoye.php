                ...
                <div class="container pos-vertical-center">
                    <div class="row">
                        <div class="col-lg-5 col-md-8">
                            <h2>Bravo</h2>
                            <p class="lead">Votre nouveau mot de passe vient de vous être envoyé par Mail.</p>
                            <button class="btn btn--primary type--uppercase"><a href="index.php">Allez au l'accueil</a></button>
